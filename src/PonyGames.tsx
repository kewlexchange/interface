...
import ICON_LOGO from './assets/images/platform/ponygames.svg';
...
import PonyGamesHead from './Components/Head/ponygames';
        ...
        >
          ...
          <NavbarContent className="sm:hidden pr-3" justify="center">
            <NavbarBrand as={NavLink} to={"/"}>
              <img className={"h-[45px] w-[45px]"} alt={"PonyGames Logo"} src={ICON_LOGO} />
            </NavbarBrand>
          </NavbarContent>
          ...
          <NavbarContent className="hidden sm:flex gap-4" justify="center">
            ...
            <NavbarItem className='flex flex-row items-center justify-center'>
              <Link color="foreground" as={NavLink} to={"/games"}>

                <span>{t("Games")}</span></Link>
            </NavbarItem>
