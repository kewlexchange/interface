...
import { useDomainContract, useCHZINULaunchpadContract, useCHILIZPEPELaunchpadContract, useCHILIZPEPELaunchpadSecondContract } from '../../hooks/useContract';
import useModal, { ModalInfo, ModalLoading, ModalSuccessTransaction, ModalSelectToken } from '../../hooks/useModals';
import CHZINU_LOGO from "./chilizpeperound2.jpg"
...
const _CHILIZPEPEIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useCHILIZPEPELaunchpadSecondContract(chainId, true);
            ...
            <div className={"w-full rounded-lg p-2"}>
                ...
                <div className="rounded-lg flex items-center justify-center gap-2 flex-col">
                    ...
                    <div className={"w-full flex gap-2 flex-col rounded-lg  py-2"}>
                        ...
                        >
                            ...
                            <CardBody>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>0.00010461542 CHZ</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Token Amount</span>
                                    <span className={"font-bold text-warning-600"}>1.750.000.000 CHZPEPE</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Soft Capitalization</span>
                                    <span className={"font-bold text-warning-600"}>140.000 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Hard Capitalization</span>
                                    <span className={"font-bold text-warning-600"}>183.100 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Fully Diluted Valuation</span>
                                    <span className={"font-bold text-warning-600"}>108.000 USD</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Start Date</span>
                                    <span className={"font-bold text-warning-600"}>April 24th, Tuesday, 13:00 UTC</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                        ...
                        <Button className='w-full' to={"/launchpad/chzpepefirst"} as={NavLink} color='danger' size='lg'>SWITCH TO CHZPEPE IDO - ROUND 1</Button>




                        <Card className='p-2'>
                            <Tabs selectedKey={"refund"} size={"lg"} color='warning' aria-label="Tabs sizes">
                                    ...
                                    <Card className='w-full flex flex-col gap-2'>
                                        ...
                                        <CardBody>
                                            ...
                                            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                                ...
                                                }} color={"danger"} size="lg">I acknowledge that CHZPEPE is a MEME token and understand that I am solely responsible for any potential losses incurred.</Switch>
                                        ...
                                        <CardHeader className="flex justify-between items-start">
                                            <div className="flex gap-5">
                                                ...
                                                <div className="flex flex-col gap-1 items-start justify-center">
                                                    ...
                                                    <h5 className="text-small tracking-tight  text-secondary-400">Thank you for participating in the CHZPEPE project on the IMON Launchpad.</h5>
                                                </div>
...
export const CHILIZPEPESECONDIDO = memo(_CHILIZPEPEIDO)
