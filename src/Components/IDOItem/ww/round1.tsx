...
import { useDomainContract, useWWLaunchpadContract} from '../../../hooks/useContract';
import useModal, { ModalInfo, ModalLoading, ModalSuccessTransaction, ModalSelectToken } from '../../../hooks/useModals';
import CHZINU_LOGO from "../ww.svg"
...
const _MRLIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useWWLaunchpadContract(chainId, true);
                                ...
                                <Card fullWidth shadow='none' >
                                    <CardHeader className="justify-between">
                                        <div className="flex gap-5">
                                            ...
                                            <div className="flex flex-col gap-1 items-start justify-center">
                                                <h4 className="text-small font-semibold leading-none text-default-600">WHOWINS</h4>
                                                <h5 className="text-small tracking-tight text-default-400">WW</h5>
                                            </div>
                                        </div>
                                    ...
                                    <CardBody>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>WHOWINS</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Symbol</span>
                                            <span className={"font-bold text-warning-600"}>WW</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>0.00145 CHZ</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Token Amount</span>
                                            <span className={"font-bold text-warning-600"}>200.000.000 WW</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Soft Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>75.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Hard Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>290.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Fully Diluted Valuation</span>
                                            <span className={"font-bold text-warning-600"}>175.000 USD</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Start Date</span>
                                            <span className={"font-bold text-warning-600"}>Jun 11, Wednesday, 17:00 UTC</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>End Date</span>
                                            <span className={"font-bold text-warning-600"}>Jun 13, Thursday, 17:00 UTC</span>
                                        </div>
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                ...
                                <Card fullWidth shadow='none' className='w-full flex flex-col gap-2'>
                                    <CardHeader className="flex justify-between items-start">
                                        <div className="flex gap-5">
                                            ...
                                            <div className="flex flex-col gap-1 items-start justify-center">
                                                <h4 className="text-small font-semibold leading-none text-default-600">Introducing WW Token</h4>

                                                <h5 className="text-small tracking-tight text-warning-400">
                                                WHOWINS is an innovative platform that combines the excitement of sports with blockchain technology, allowing users to support their favorite teams and earn rewards based on their performance. Join us in revolutionizing the sports fan experience!
                                                </h5>
                                            </div>
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                            ...
                                            <div className="w-full flex flex-col gap-2">
                                                ...
                                                }} color={"danger"} size="lg">I acknowledge that WW is a MEME token and understand that I am solely responsible for any potential losses incurred.</Switch>
...
export const WWROUND1IDO = memo(_MRLIDO)
