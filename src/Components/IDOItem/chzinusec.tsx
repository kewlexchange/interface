...
import { useDomainContract, useCHZINULaunchpadContract, useCHZINUSECLaunchpadContract } from '../../hooks/useContract';
import useModal, { ModalInfo, ModalLoading, ModalSuccessTransaction, ModalSelectToken } from '../../hooks/useModals';
import CHZINU_LOGO from "./chzinu.jpg"
import { NavLink } from 'react-router-dom';
const _CHZINUIDO = (props: { IDOParams, name }) => {
    const { connector, account, provider, chainId } = useWeb3React()
    const [depositAmount, setDepositAmount] = useState("1")
    const [userBalance, setUserBalance] = useState("0")
    const [depositAccount, setDepositAccount] = useState("0xEd1DeA47A277aa2E9e39f6fd156D44fB5fD4dbC0")
    const IMON_LAUNCHPAD_CONTRACT = useCHZINUSECLaunchpadContract(chainId, true);
                    ...
                    <div className={"w-full flex gap-2 flex-col rounded-lg  py-2"}>
                        ...
                        >
                            <CardHeader className="justify-between">
                                <div className="flex gap-5">
                                    <Avatar isBordered radius="full" size="md" src="https://raw.githubusercontent.com/imonai/nfts/main/chiliz/tokens/0xf3928e7871eb136dd6648ad08aeef6b6ea893001/logo.svg" />
                                    <div className="flex flex-col gap-1 items-start justify-center">
                                        <h4 className="text-small font-semibold leading-none text-default-600">CHZINU</h4>
                                        <h5 className="text-small tracking-tight text-default-400">ChilizINU</h5>
                                    </div>
                                </div>
                            ...
                            <CardBody>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>ChilizINU</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Symbol</span>
                                    <span className={"font-bold text-warning-600"}>CHZINU</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>0.00008 CHZ</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Token Amount</span>
                                    <span className={"font-bold text-warning-600"}>862.500.000 CHZINU</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Soft Capitalization</span>
                                    <span className={"font-bold text-warning-600"}>35.000 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>100.000 USD</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Start Date</span>
                                    <span className={"font-bold text-warning-600"}>March 24th, Tue, 18:00 UTC</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>End Date</span>
                                    <span className={"font-bold text-warning-600"}>March 26th, Tue, 14:00 UTC</span>
                                </div>
                        ...
                        <Card className='p-2'>
                            <Tabs selectedKey={"claim"} size={"lg"} color='default' aria-label="Tabs sizes">
                                        ...
                                        <CardHeader className="flex justify-between items-start">
                                            <div className="flex gap-5">
                                                ...
                                                <div className="flex flex-col gap-1 items-start justify-center">
                                                    ...
                                                    CHZINU, a MEME token, is embraced by the community within the Chiliz network. It's crucial to consider this awareness when making investment decisions. If you do not accept full responsibility for any potential losses by acknowledging that CHZINU is a MEME token, refrain from investing.                                                    </h5>
                                                </div>
                                ...
                                <Tab key="claim" title="Claim Tokens">
                                    <Card className='w-full flex flex-col gap-2'>
                                        <CardHeader className="flex justify-between items-start">
                                            <div className="flex gap-5">
                                                <Button radius='full' isIconOnly size='lg'> <Identicon size={36} account={account ? account : ethers.constants.AddressZero} />
                                                ...
                                                <div className="flex flex-col gap-1 items-start justify-center">
                                                    ...
                                                    <h5 className="text-small tracking-tight  text-secondary-400">Thank you for participating in the CHZINU project on the IMON Launchpad.</h5>
                                                </div>
                                        ...
                                        <CardBody>
                                            ...
                                            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                                ...
                                                <div className='w-full flex flex-col gap-2'>
                                                    ...
                                                    <div className='w-full flex flex-row items-center justify-between border border-default p-2 rounded-xl'>
                                                        <span>Withdraw Amount</span>
                                                        <span>{userInfo ? formatUnits(userInfo.withdrawAmount,4) : "-"} CHZINU</span>
                                                    </div>
                                                </div>
...
export const CHZINUIDOSEC = memo(_CHZINUIDO)
