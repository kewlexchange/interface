...
import { useDomainContract, useCHZINULaunchpadContract, useTBTLaunchpadThirdContract, useCHILIZPEPELaunchpadSecondContract, useAngryHoopLaunchpadSecondContract } from '../../../hooks/useContract';
...
const _ANGRYHOOPIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useTBTLaunchpadThirdContract(chainId, true);
    ...
    const [hardCap, setHardCap] = useState(parseEther("432000"))
                                ...
                                <Card fullWidth shadow='none' >
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>0.00096 CHZ</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Token Amount</span>
                                            <span className={"font-bold text-warning-600"}>450.000.000 TBT</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Soft Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>192.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Hard Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>432.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Fully Diluted Valuation</span>
                                            <span className={"font-bold text-warning-600"}>180.000 USD</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Start Date</span>
                                            <span className={"font-bold text-warning-600"}>May 2, Thursday, 20:00 UTC+3</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>UNLIMITED</span>
                                        </div>
...
export const TBTROUND3IDO = memo(_ANGRYHOOPIDO)
