...
import { useDomainContract, useCHZINULaunchpadContract, useTBTLaunchpadFirstContract, useCHILIZPEPELaunchpadSecondContract, useAngryHoopLaunchpadSecondContract } from '../../../hooks/useContract';
...
const _ANGRYHOOPIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useTBTLaunchpadFirstContract(chainId, true);
                                ...
                                <Card fullWidth shadow='none' >
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>0.0008 CHZ</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Token Amount</span>
                                            <span className={"font-bold text-warning-600"}>250.000.000 TBT</span>
                                        </div>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>April 26, Friday, 20:00 UTC+3</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>200 CHZ</span>
                                        </div>
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Maximum Buy</span>
                                            <span className={"font-bold text-warning-600"}>500 CHZ</span>
                                        </div>
...
export const TBTROUND1IDO = memo(_ANGRYHOOPIDO)
