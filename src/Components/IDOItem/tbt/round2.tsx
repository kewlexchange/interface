...
import { useDomainContract, useCHZINULaunchpadContract, useTBTLaunchpadFirstContract, useCHILIZPEPELaunchpadSecondContract, useAngryHoopLaunchpadSecondContract, useTBTLaunchpadSecondContract } from '../../../hooks/useContract';
...
const _ANGRYHOOPIDO = (props: { IDOParams, name }) => {
    ...
    const [hardCap, setHardCap] = useState(parseEther("264000"))
                                ...
                                <Card fullWidth shadow='none'>
                                    <CardHeader className="justify-between">
                                        <div className="flex gap-5">
                                            <Avatar isBordered radius="full" size="md" src="https://raw.githubusercontent.com/imonai/nfts/main/chiliz/tokens/0xfed7a6423cdebb4c05552dc888de5acc657444f4/logo.svg" />
                                            <div className="flex flex-col gap-1 items-start justify-center">
                                                <h4 className="text-small font-semibold leading-none text-default-600">TBT</h4>
                                                <h5 className="text-small tracking-tight text-default-400">TBT</h5>
                                            </div>
                                        </div>
                                    ...
                                    <CardBody>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>TBT</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>1.500.000.000,00</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>300.000.000 TBT</span>
                                        </div>

                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Soft Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>132.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Hard Capitalization</span>
                                            <span className={"font-bold text-warning-600"}>264.000 CHZ</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Fully Diluted Valuation</span>
                                            <span className={"font-bold text-warning-600"}>165.000 USD</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>Start Date</span>
                                            <span className={"font-bold text-warning-600"}>April 30, Tuesday, 20:00 UTC+3</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            <span className={"font-normal"}>End Date</span>
                                            <span className={"font-bold text-warning-600"}>May 3, Friday, 20:00 UTC+3</span>
                                        </div>
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                        ...
                                        <div className=' w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>2000 CHZ</span>
                                        </div>
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                            ...
                                            <Slider
                                                ...
                                                maxValue={2000}
                                                minValue={1}
                                                value={depositAmount === "" ? 2000 : parseFloat(depositAmount)}
...
export const TBTROUND2IDO = memo(_ANGRYHOOPIDO)
