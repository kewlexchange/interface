                                ...
                                <Card fullWidth shadow='none' >
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between'>
                                            ...
                                            <span className={"font-bold text-warning-600"}>July 27, Thursday, 12:00 UTC+3</span>
                                        </div>
                                        <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <CardBody>
                                        ...
                                        <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                            ...
                                            <div className="w-full flex flex-col gap-2">
                                                ...
                                                }} color={"danger"} size="lg">I acknowledge that DSWAP is a Native DEX token and understand that I am solely responsible for any potential losses incurred.</Switch>
