...
import { useDomainContract, useCHZINULaunchpadContract } from '../../hooks/useContract';
...
const _CHZINUIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useCHZINULaunchpadContract(chainId, true);
                        ...
                        >
                            ...
                            <CardBody>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>0.00006896551 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>March 19th, Tue, 12:00 UTC</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>End Date</span>
                                    <span className={"font-bold text-warning-600"}>March 26th, Tue, 12:00 UTC</span>
                                </div>
...
export const CHZINUIDO = memo(_CHZINUIDO)
