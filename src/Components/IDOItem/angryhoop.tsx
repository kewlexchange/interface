...
import { useDomainContract, useCHZINULaunchpadContract, useCHILIZPEPELaunchpadContract, useCHILIZPEPELaunchpadSecondContract, useAngryHoopLaunchpadSecondContract } from '../../hooks/useContract';
import useModal, { ModalInfo, ModalLoading, ModalSuccessTransaction, ModalSelectToken } from '../../hooks/useModals';
import CHZINU_LOGO from "./angryhoop.jpg"
...
const _ANGRYHOOPIDO = (props: { IDOParams, name }) => {
    ...
    const IMON_LAUNCHPAD_CONTRACT = useAngryHoopLaunchpadSecondContract(chainId, true);
                    ...
                    <div className={"w-full flex gap-2 flex-col rounded-lg  py-2"}>
                        ...
                        >
                            <CardHeader className="justify-between">
                                <div className="flex gap-5">
                                    <Avatar isBordered radius="full" size="md" src="https://raw.githubusercontent.com/imonai/nfts/main/chiliz/tokens/0x3720526d4d4c93b9db7c293587ec02782dc729d9/logo.svg" />
                                    <div className="flex flex-col gap-1 items-start justify-center">
                                        <h4 className="text-small font-semibold leading-none text-default-600">ANGRY HOOP</h4>
                                        <h5 className="text-small tracking-tight text-default-400">ANGRY</h5>
                                    </div>
                                </div>
                            ...
                            <CardBody>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>ANGRY HOOP</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Symbol</span>
                                    <span className={"font-bold text-warning-600"}>ANGRY</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>1.000.000.000,00</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                ...
                                <div className='w-full flex flex-row items-center justify-between'>
                                    ...
                                    <span className={"font-bold text-warning-600"}>0.00088 CHZ</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Token Amount</span>
                                    <span className={"font-bold text-warning-600"}>500.000.000,00 ANGRY</span>
                                </div>

                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Soft Capitalization</span>
                                    <span className={"font-bold text-warning-600"}>200.000 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Hard Capitalization</span>
                                    <span className={"font-bold text-warning-600"}>400.000 CHZ</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Fully Diluted Valuation</span>
                                    <span className={"font-bold text-warning-600"}>110.000 USD</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>Start Date</span>
                                    <span className={"font-bold text-warning-600"}>April 25th, Thursday, 15:00 UTC+3</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                                    <span className={"font-normal"}>End Date</span>
                                    <span className={"font-bold text-warning-600"}>April 25th, Thursday, 20:30 UTC+3</span>
                                </div>
                                <div className='w-full flex flex-row items-center justify-between'>
                        ...
                        <Card className='p-2'>
                            <Tabs selectedKey={"claim"} size={"lg"} color='default' aria-label="Tabs sizes">
                                    ...
                                    <Card className='w-full flex flex-col gap-2'>
                                        <CardHeader className="flex justify-between items-start">
                                            <div className="flex gap-5">
                                                ...
                                                <div className="flex flex-col gap-1 items-start justify-center">
                                                    ...
                                                    ANGRY HOOP, a MEME token, is embraced by the community within the Chiliz network. It's crucial to consider this awareness when making investment decisions. If you do not accept full responsibility for any potential losses by acknowledging that ANGRY HOOP is a MEME token, refrain from investing.                                                    </h5>
                                                </div>
                                        ...
                                        <CardBody>
                                            ...
                                            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                                ...
                                                }} color={"default"} size="lg">I acknowledge that ANGRY HOOP is a MEME token and understand that I am solely responsible for any potential losses incurred.</Switch>
                                ...
                                <Tab isDisabled={false} key="claim" title="Claim Tokens">
                                    <Card className='w-full flex flex-col gap-2'>
                                        <CardHeader className="flex justify-between items-start">
                                            <div className="flex gap-5">
                                                <Button radius='full' isIconOnly size='lg'> <Identicon size={36} account={account ? account : ethers.constants.AddressZero} />
                                                ...
                                                <div className="flex flex-col gap-1 items-start justify-center">
                                                    ...
                                                    <h5 className="text-small tracking-tight  text-secondary-400">Thank you for participating in the ANGRY HOOP project on the KEWL Launchpad.</h5>
                                                </div>
                                        ...
                                        <CardBody>
                                            ...
                                            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                                ...
                                                <div className='w-full flex flex-col gap-2'>
                                                    ...
                                                    <div className='w-full flex flex-row items-center justify-between border border-default p-2 rounded-xl'>
                                                        <span>Withdraw Amount</span>
                                                        <span>{userInfo ? formatUnits(userInfo.withdrawAmount,18) : "-"} ANGRY</span>
                                                    </div>
                                                </div>
...
export const ANGRYHOOPIDO = memo(_ANGRYHOOPIDO)
