                                    ...
                                    <Card className='w-full flex flex-col gap-2'>
                                        ...
                                        <CardBody>
                                            ...
                                            <div className='w-full flex flex-col gap-2 items-center justify-center'>
                                                ...
                                                }} color={"danger"} size="lg">I acknowledge that ANGRY HOOP is a MEME token and understand that I am solely responsible for any potential losses incurred.</Switch>
