...
import { STAKE_ITEM } from './StakeItem';
                ...
                <Accordion  isCompact={true} variant="light"  selectionMode="multiple">
                    ...
                    {userStakings && userStakings.map((stakingItem,index)=>{
                                    ...
                                    title={stakingItem?.poolInfo?.tokenInfo?.symbol}>
                                        <STAKE_ITEM isPair={searchByAddress(stakingItem.token)} userAccount={userAccount} nft={nftContract} assets={defaultAssets} rewardPools={rewardPools} stakeItem={stakingItem}/>
